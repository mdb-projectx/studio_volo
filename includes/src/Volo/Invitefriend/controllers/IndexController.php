													...
													<tr>
														<td valign="top" align="center" height="80" style="border-collapse: collapse;">
															<table border="0" cellpadding="0" cellspacing="0" width="630" height="80" id="contentHead">
																<tr>
																	<td width="630" height="80" align="center" style="border-collapse: collapse;"><a href="http://www.capsulehome.com"><img src="'.$baseurl.'/skin/frontend/default/respond/invitefriend/logo.png" width="570" height="80" alt="Volo" style="vertical-align:top;display:block;border: 0;outline: none;text-decoration: none;"></a></td>
																</tr>
															</table>
														</td>
													</tr>														
																...
																<tr>
																	<td align="left" width="580" height="330" valign="top" style="border-collapse: collapse;display:block;">															
																		<p style="margin: 0;font-family: Lato,\'Lucida Sans Unicode\',\'Lucida Grande\',Arial,Helvetica,sans-serif;font-size: 14px;line-height: 21px;">																		
																			...
																			<a href="http://www.capsulehome.com"><img src="'.$baseurl.'/skin/frontend/default/respond/invitefriend/shop.png" width="170" height="40" alt="Start Shopping" style="border: 0;height: auto;outline: none;text-decoration: none;"></a><br><br>
																			'.$firstname.' '.$lastname.'
																		</p>															
																	</td>
																</tr>
