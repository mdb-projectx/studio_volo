...
class Stripe_ApiRequestor
{
  ...
  private function _requestRaw($method, $url, $params)
  {
    ...
    $uname = php_uname();
    $ua = array(
        'bindings_version' => Stripe_Stripe::VERSION,
        'lang' => 'php',
    ...
    $headers = array(
        ...
        'User-Agent: Stripe/v1 PhpBindings/' . Stripe_Stripe::VERSION,
        'Authorization: Bearer ' . $myApiKey,
        'Content-Type: application/x-www-form-urlencoded',
    );
    if (Stripe_Stripe::$apiVersion) {
      $headers[] = 'Stripe-Version: ' . Stripe_Stripe::$apiVersion;
    }
  ...
  private function _curlRequest($method, $absUrl, $headers, $params)
  {
    ...
    if (!Stripe_Stripe::$verifySslCerts)
  ...
  {
  	//Magento compilation trick
  	if( defined('COMPILER_INCLUDE_PATH') ) {
  		return MAGENTO_ROOT . '/lib/Stripe/data/ca-certificates.crt';
  	}
