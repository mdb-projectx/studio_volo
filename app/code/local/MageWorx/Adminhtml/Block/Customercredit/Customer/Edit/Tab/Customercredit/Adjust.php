...
class MageWorx_Adminhtml_Block_Customercredit_Customer_Edit_Tab_Customercredit_Adjust extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm() {
        ...
        $fieldset->addField('credit_value', 'hidden', array(
            'name'     => 'credit_value',            
            'after_element_html' => '</td></tr><tr><td class="label">'.$helper->__('Current Balance').'</td><td id="customercredit_credit_website_value" class="value">'.Mage::helper('core')->currency($creditValue),
        ));                
