...
class Wyomind_Datafeedmanager_Block_Adminhtml_Configurations_Edit_Tab_Configuration extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        ($model->getFeedName()) ? $fn = $model->getFeedName() : $fn = "filename";
        ...
        $fieldset->addField('feed_dateformat', 'select', array(
            'label' => Mage::helper('datafeedmanager')->__('File name format '),
            'name' => 'feed_dateformat',
            'values' => array(
                array(
                    'value' => '{f}',
        ...
        $fieldset->addField('feed_extrafooter', 'textarea', array(
            'label' => (Mage::helper('datafeedmanager')->__('Extra footer')),
            'class' => 'txt-type not-required refresh',
            'name' => 'feed_extrafooter',
            'style' => 'height:75px;width:450px;resize:vertical',
        ));
