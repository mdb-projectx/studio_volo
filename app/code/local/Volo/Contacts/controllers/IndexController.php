 ...
 */
class Volo_Contacts_IndexController extends Mage_Core_Controller_Front_Action
{
...
/*
	if (!Mage::getSingleton('customer/session')->isLoggedIn()) {
            ...
            $session->setAfterAuthUrl('/invite' );
            $session->setBeforeAuthUrl( '/invite' );
...
*/
		$result='NoEmail';
                ...
                $select="SELECT * FROM customer_entity where entity_id='".$Id."'";
