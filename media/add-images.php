...
while (!feof($file_handle) ) {
	...
	if($ourProduct) {
		...
		if (file_exists($filePath)) {
			...
			if( strstr($fileName, 'content-w') || strstr($fileName, 'content_w') || strstr($fileName, 'contentw') ) {
				// $ourProduct->addImageToMediaGallery($filePath, array('image'), false, false);
				$position = 1;
				$type = 'image';
				$exclude = 0;
			} elseif( strstr($fileName, 'content-1') || strstr($fileName, 'content_1') || strstr($fileName, 'content1') ) {
				// $ourProduct->addImageToMediaGallery($filePath, array('feature_image'), false, false);
				$position = 2;
				$type = 'feature_image';
				$exclude = 0;
			} elseif( strstr($fileName, 'content-2') || strstr($fileName, 'content_2') || strstr($fileName, 'content2') ) {
				// $ourProduct->addImageToMediaGallery($filePath, array('feature_image2'), false, false);
				$position = 3;
				$type = 'feature_image2';
				$exclude = 0;
			} elseif( strstr($fileName, 'content-3') || strstr($fileName, 'content_3') || strstr($fileName, 'content3') ) {
				// $ourProduct->addImageToMediaGallery($filePath, array('feature_image3'), false, false);
				$position = 4;
				$type = 'feature_image3';
				$exclude = 0;
			} elseif( strstr($fileName, 'content-4') || strstr($fileName, 'content_4') || strstr($fileName, 'content4') ) {
				// $ourProduct->addImageToMediaGallery($filePath, array('feature_image4'), false, false);
				$position = 5;
				$type = 'feature_image4';
				$exclude = 0;
			} elseif( strstr($fileName, 'content-5') || strstr($fileName, 'content_5') || strstr($fileName, 'content5') ) {
				// $ourProduct->addImageToMediaGallery($filePath, array('feature_image4'), false, false);
				$position = 6;
				$type = '';
				$exclude = 0;
			} elseif( strstr($fileName, 'content-6') || strstr($fileName, 'content_6') || strstr($fileName, 'content6') ) {
				// $ourProduct->addImageToMediaGallery($filePath, array('feature_image4'), false, false);
				$position = 7;
				$type = '';
				$exclude = 0;
			} elseif( strstr($fileName, 'content-7') || strstr($fileName, 'content_7') || strstr($fileName, 'content7') ) {
				// $ourProduct->addImageToMediaGallery($filePath, array('feature_image4'), false, false);
				$position = 8;
				$type = '';
				$exclude = 0;
			} elseif( strstr($fileName, 'content-8') || strstr($fileName, 'content_8') || strstr($fileName, 'content8') ) {
				// $ourProduct->addImageToMediaGallery($filePath, array('feature_image4'), false, false);
				$position = 9;
				$type = '';
				$exclude = 0;
			} elseif( strstr($fileName, 'content-9') || strstr($fileName, 'content_9') || strstr($fileName, 'content9') ) {
				// $ourProduct->addImageToMediaGallery($filePath, array('feature_image4'), false, false);
				$position = 10;
				$type = '';
				$exclude = 0;
			} elseif( strstr($fileName, 'thumbnail-1') || strstr($fileName, 'thumbnail_1') || strstr($fileName, 'thumbnail1') ) {
				// $ourProduct->addImageToMediaGallery($filePath, array('thumbnail'), false, true);
				$position = 12;
				$type = 'thumbnail';
				$exclude = 1;
			} elseif( strstr($fileName, 'thumbnail-2') || strstr($fileName, 'thumbnail_2') || strstr($fileName, 'thumbnail2') ) {
				// $ourProduct->addImageToMediaGallery($filePath, array('small_image'), false, true);
				$position = 12;
				$type = 'small_image';
				$exclude = 1;
			} elseif( strstr($fileName, 'thumbnail-3') || strstr($fileName, 'thumbnail_3') || strstr($fileName, 'thumbnail3') ) {
				// $ourProduct->addImageToMediaGallery($filePath, array('thumbnail'), false, true);
				$position = 12;
				$type = '';
				$exclude = 1;
			} elseif( strstr($fileName, 'thumbnail-4') || strstr($fileName, 'thumbnail_4') || strstr($fileName, 'thumbnail4') ) {
				// $ourProduct->addImageToMediaGallery($filePath, array('small_image'), false, true);
				$position = 12;
				$type = '';
				$exclude = 1;
			} elseif( strstr($fileName, 'thumbnail-5') || strstr($fileName, 'thumbnail_5') || strstr($fileName, 'thumbnail5') ) {
				// $ourProduct->addImageToMediaGallery($filePath, array('small_image'), false, true);
				$position = 12;
				$type = '';
				$exclude = 1;
